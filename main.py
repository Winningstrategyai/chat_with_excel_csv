...
def read_file(uploaded_file):
    ...
    if file_extension.lower() == ".csv":
        ...
        os.remove("temp_file.csv")  # Remove the temporary file
        ...
        os.remove("temp_file.xlsx")  # Remove the temporary file
    else:
...
def main():
    st.set_page_config(page_title="Winning_Stategy_product",
                       page_icon=":rocket:")
    st.subheader("Chatbot to interact with Excel or CSV :robot_face:")
